export const Spreadsheets = {
    ...
    sections:[
        {name:'Alerts',columns:['Stock', 'Time'],range:'Sheet1!A5:B20'},
        {name:'Orders',columns:['Stock','Price','Time','Status'],range:'Sheet1!D5:G20'},
        {name:'Positions',columns:['Stock','Bought Price','Current Price','Pnl','Status'],range:'Sheet1!I5:M20'}
    ]
    },
