...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/HoldingResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/HoldingResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.HoldingsApi = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.HoldingResponse);
  }
}(this, function(ApiClient, HoldingResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getHolding operation.
     * @callback module:api/HoldingsApi~getHoldingCallback
     ...
     * @param {module:api/HoldingsApi~getHoldingCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/HoldingResponse}
     */
    this.getHolding = function(xSessionToken, callback) {
      var postBody = null;

      // verify the required parameter 'xSessionToken' is set
      if (xSessionToken === undefined || xSessionToken === null) {
        throw new Error("Missing the required parameter 'xSessionToken' when calling getHolding");
      }
      ...
      var returnType = HoldingResponse;
