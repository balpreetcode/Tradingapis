...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OptionChainResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/OptionChainResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.OptionApi = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.OptionChainResponse);
  }
}(this, function(ApiClient, OptionChainResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/OptionApi~getOptionContractsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OptionChainResponse} data The data returned by the service call.
     ...
     * @param {String} searchSymbolName Trading Symbol of the scrip to be searched
     ...
     * @param {String} opts.expiryDate From date in yyyy-MM-dd
     * @param {String} opts.strikePrice The strike price is the predetermined price at which a put buyer can sell the underlying asset
     * @param {String} opts.optionType Option Type (PE/CE). 
     * @param {module:api/OptionApi~getOptionContractsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OptionChainResponse}
     */
    this.getOptionContracts = function(xSessionToken, searchSymbolName, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'xSessionToken' is set
      if (xSessionToken === undefined || xSessionToken === null) {
        throw new Error("Missing the required parameter 'xSessionToken' when calling getOptionContracts");
      }

      // verify the required parameter 'searchSymbolName' is set
      if (searchSymbolName === undefined || searchSymbolName === null) {
        throw new Error("Missing the required parameter 'searchSymbolName' when calling getOptionContracts");
      }
      ...
      var returnType = OptionChainResponse;
