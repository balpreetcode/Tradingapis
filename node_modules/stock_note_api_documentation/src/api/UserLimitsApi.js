...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LimitResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/LimitResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.UserLimitsApi = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.LimitResponse);
  }
}(this, function(ApiClient, LimitResponse) {
  'use strict';

  /**
   * UserLimits service.
   * @module api/UserLimitsApi
   * @version 1.0
   */

  /**
   * Constructs a new UserLimitsApi. 
   * @alias module:api/UserLimitsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getLimits operation.
     * @callback module:api/UserLimitsApi~getLimitsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LimitResponse} data The data returned by the service call.
     ...
     * @param {module:api/UserLimitsApi~getLimitsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LimitResponse}
     */
    this.getLimits = function(xSessionToken, callback) {
      var postBody = null;

      // verify the required parameter 'xSessionToken' is set
      if (xSessionToken === undefined || xSessionToken === null) {
        throw new Error("Missing the required parameter 'xSessionToken' when calling getLimits");
      }
