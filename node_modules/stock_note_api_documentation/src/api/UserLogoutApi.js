...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('../model/SimpleResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.UserLogoutApi = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.SimpleResponse);
  }
  ...
  /**
   * UserLogout service.
   * @module api/UserLogoutApi
   * @version 1.0
   */

  /**
   * Constructs a new UserLogoutApi. 
   * @alias module:api/UserLogoutApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/UserLogoutApi~logoutCallback
     ...
     * @param {module:api/UserLogoutApi~logoutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SimpleResponse}
     */
    this.logout = function(xSessionToken, callback) {
      var postBody = null;

      // verify the required parameter 'xSessionToken' is set
      if (xSessionToken === undefined || xSessionToken === null) {
        throw new Error("Missing the required parameter 'xSessionToken' when calling logout");
      }
