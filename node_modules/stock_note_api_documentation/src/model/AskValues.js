...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.AskValues = factory(root.StockNoteApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AskValues model module.
   * @module model/AskValues
   * @version 1.0
   */

  /**
   * Constructs a new <code>AskValues</code>.
   * @alias module:model/AskValues
   * @class
   * @param _number {String} Sequence number for Bid/Ask
   * @param quantity {String} Quantity asked for trading.
   * @param price {String} Price asked for trading.
   */
  var exports = function(_number, quantity, price) {
  ...
  /**
   * Constructs a <code>AskValues</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AskValues} obj Optional instance to populate.
   * @return {module:model/AskValues} The populated <code>AskValues</code> instance.
   */
  ...
  /**
   * Sequence number for Bid/Ask
   * @member {String} _number
   */
  exports.prototype._number = undefined;

  /**
   * Quantity asked for trading.
   * @member {String} quantity
   */
  exports.prototype.quantity = undefined;

  /**
   * Price asked for trading.
   * @member {String} price
   */
