...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.BidAsk = factory(root.StockNoteApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The BidAsk model module.
   * @module model/BidAsk
   * @version 1.0
   */

  /**
   * Constructs a new <code>BidAsk</code>.
   * @alias module:model/BidAsk
   * @class
   * @param number {String} Sequence number for Bid/Ask
   * @param quantity {String} Quantity asked for trading.
   * @param price {String} Price asked for trading.
   */
  var exports = function(number, quantity, price) {
    this.number = number;
  ...
  /**
   * Constructs a <code>BidAsk</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BidAsk} obj Optional instance to populate.
   * @return {module:model/BidAsk} The populated <code>BidAsk</code> instance.
   */
