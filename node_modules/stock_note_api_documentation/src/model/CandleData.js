...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.CandleData = factory(root.StockNoteApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CandleData model module.
   * @module model/CandleData
   * @version 1.0
   */

  /**
   * Constructs a new <code>CandleData</code>.
   * @alias module:model/CandleData
   * @class
  ...
  /**
   * Constructs a <code>CandleData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CandleData} obj Optional instance to populate.
   * @return {module:model/CandleData} The populated <code>CandleData</code> instance.
   */
