...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CandleData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CandleData'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.HistoricalCandleResponse = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.CandleData);
  }
}(this, function(ApiClient, CandleData) {
  'use strict';

  /**
   * The HistoricalCandleResponse model module.
   * @module model/HistoricalCandleResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>HistoricalCandleResponse</code>.
   * @alias module:model/HistoricalCandleResponse
   * @class
   ...
   * @param historicalCandleData {Array.<module:model/CandleData>} Get List of CandleData .
   */
  var exports = function(serverTime, msgId, status, statusMessage, historicalCandleData) {
  ...
  /**
   * Constructs a <code>HistoricalCandleResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HistoricalCandleResponse} obj Optional instance to populate.
   * @return {module:model/HistoricalCandleResponse} The populated <code>HistoricalCandleResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('historicalCandleData'))
        obj.historicalCandleData = ApiClient.convertToType(data['historicalCandleData'], [CandleData]);
    }
    return obj;
  }
  ...
  /**
   * Get List of CandleData .
   * @member {Array.<module:model/CandleData>} historicalCandleData
   */
  exports.prototype.historicalCandleData = undefined;
