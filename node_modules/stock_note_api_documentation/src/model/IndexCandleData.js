...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.IndexCandleData = factory(root.StockNoteApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The IndexCandleData model module.
   * @module model/IndexCandleData
   * @version 1.0
   */

  /**
   * Constructs a new <code>IndexCandleData</code>.
   * @alias module:model/IndexCandleData
   * @class
   * @param date {String} Date for which CandleData shown
   * @param open {String} Opening price of a market snapshot
   * @param high {String} High value of market snapshot
   * @param low {String} Low value of market snapshot
   * @param close {String} Close value of market snapshot
   ...
   */
  var exports = function(date, open, high, low, close, ltp, volume) {
    this.date = date;
    this.open = open;
    this.high = high;
    this.low = low;
  ...
  /**
   * Constructs a <code>IndexCandleData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IndexCandleData} obj Optional instance to populate.
   * @return {module:model/IndexCandleData} The populated <code>IndexCandleData</code> instance.
   */
  ...
  /**
   * Date for which CandleData shown
   * @member {String} date
   */
