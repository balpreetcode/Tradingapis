...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/IndexCandleData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./IndexCandleData'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.IndexCandleDataResponse = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.IndexCandleData);
  }
}(this, function(ApiClient, IndexCandleData) {
  'use strict';

  /**
   * The IndexCandleDataResponse model module.
   * @module model/IndexCandleDataResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>IndexCandleDataResponse</code>.
   * @alias module:model/IndexCandleDataResponse
   * @class
   ...
   * @param indexCandleData {Array.<module:model/IndexCandleData>} Get List of IndexData .
   */
  var exports = function(serverTime, msgId, status, statusMessage, indexCandleData) {
  ...
  /**
   * Constructs a <code>IndexCandleDataResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IndexCandleDataResponse} obj Optional instance to populate.
   * @return {module:model/IndexCandleDataResponse} The populated <code>IndexCandleDataResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('indexCandleData'))
        obj.indexCandleData = ApiClient.convertToType(data['indexCandleData'], [IndexCandleData]);
    }
    return obj;
  }
  ...
  /**
   * Get List of IndexData .
   * @member {Array.<module:model/IndexCandleData>} indexCandleData
   */
  exports.prototype.indexCandleData = undefined;
