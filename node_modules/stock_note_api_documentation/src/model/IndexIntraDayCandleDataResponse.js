...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/IndexIntraDayCandleData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./IndexIntraDayCandleData'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.IndexIntraDayCandleDataResponse = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.IndexIntraDayCandleData);
  }
}(this, function(ApiClient, IndexIntraDayCandleData) {
  'use strict';

  /**
   * The IndexIntraDayCandleDataResponse model module.
   * @module model/IndexIntraDayCandleDataResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>IndexIntraDayCandleDataResponse</code>.
   * @alias module:model/IndexIntraDayCandleDataResponse
   * @class
   ...
   * @param statusMessage {String} Status message of the Index request
   * @param indexIntraDayCandleData {Array.<module:model/IndexIntraDayCandleData>} Get List of IndexIntraDayCandleData .
   */
  var exports = function(serverTime, msgId, status, statusMessage, indexIntraDayCandleData) {
  ...
  /**
   * Constructs a <code>IndexIntraDayCandleDataResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IndexIntraDayCandleDataResponse} obj Optional instance to populate.
   * @return {module:model/IndexIntraDayCandleDataResponse} The populated <code>IndexIntraDayCandleDataResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('indexIntraDayCandleData'))
        obj.indexIntraDayCandleData = ApiClient.convertToType(data['indexIntraDayCandleData'], [IndexIntraDayCandleData]);
    }
    return obj;
  }
  ...
  /**
   * Status message of the Index request
   * @member {String} statusMessage
   */
  exports.prototype.statusMessage = undefined;

  /**
   * Get List of IndexIntraDayCandleData .
   * @member {Array.<module:model/IndexIntraDayCandleData>} indexIntraDayCandleData
   */
  exports.prototype.indexIntraDayCandleData = undefined;
