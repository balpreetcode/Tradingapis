...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.IntraDayCandleData = factory(root.StockNoteApiDocumentation.ApiClient);
  }
   ...
   * @class
   * @param dateTime {String} Date for which CandleData shown
   ...
   */
  var exports = function(dateTime, open, high, low, close, volume) {
