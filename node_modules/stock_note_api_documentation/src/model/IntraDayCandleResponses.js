...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/IntraDayCandleData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./IntraDayCandleData'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.IntraDayCandleResponses = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.IntraDayCandleData);
  }
}(this, function(ApiClient, IntraDayCandleData) {
  'use strict';

  /**
   * The IntraDayCandleResponses model module.
   * @module model/IntraDayCandleResponses
   * @version 1.0
   */

  /**
   * Constructs a new <code>IntraDayCandleResponses</code>.
   * @alias module:model/IntraDayCandleResponses
   * @class
   ...
   * @param status {String} Response status. Can be Success or Failure
   * @param statusMessage {String} status Message
   * @param intradayCandleData {Array.<module:model/IntraDayCandleData>} Get List of IntraDayCandleData .
   */
  var exports = function(serverTime, msgId, status, statusMessage, intradayCandleData) {
  ...
  /**
   * Constructs a <code>IntraDayCandleResponses</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IntraDayCandleResponses} obj Optional instance to populate.
   * @return {module:model/IntraDayCandleResponses} The populated <code>IntraDayCandleResponses</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('intradayCandleData'))
        obj.intradayCandleData = ApiClient.convertToType(data['intradayCandleData'], [IntraDayCandleData]);
    }
    return obj;
  }
  ...
  /**
   * Response status. Can be Success or Failure
  ...
  /**
   * Get List of IntraDayCandleData .
   * @member {Array.<module:model/IntraDayCandleData>} intradayCandleData
   */
  exports.prototype.intradayCandleData = undefined;
