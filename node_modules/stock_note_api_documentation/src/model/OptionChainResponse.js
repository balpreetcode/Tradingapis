...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.OptionChainResponse = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.OptionChain);
  }
}(this, function(ApiClient, OptionChain) {
  'use strict';

  /**
   * The OptionChainResponse model module.
   * @module model/OptionChainResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>OptionChainResponse</code>.
   * @alias module:model/OptionChainResponse
   * @class
   ...
   * @param optionChainDetails {Array.<module:model/OptionChain>} Scrips Details available for the provided search text.
   */
  var exports = function(serverTime, msgId, status, statusMessage, optionChainDetails) {
  ...
  /**
   * Constructs a <code>OptionChainResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OptionChainResponse} obj Optional instance to populate.
   * @return {module:model/OptionChainResponse} The populated <code>OptionChainResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('optionChainDetails'))
        obj.optionChainDetails = ApiClient.convertToType(data['optionChainDetails'], [OptionChain]);
    }
    return obj;
  }
  ...
  /**
   * Scrips Details available for the provided search text.
   * @member {Array.<module:model/OptionChain>} optionChainDetails
   */
  exports.prototype.optionChainDetails = undefined;
