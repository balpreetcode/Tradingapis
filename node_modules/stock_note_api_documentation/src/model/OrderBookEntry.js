...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.OrderBookEntry = factory(root.StockNoteApiDocumentation.ApiClient);
  }
   ...
   * @module model/OrderBookEntry
   * @version 1.0
   */

  /**
   * Constructs a new <code>OrderBookEntry</code>.
   * @alias module:model/OrderBookEntry
   * @class
   ...
   * @param orderPrice {String} Total price of a particular order
   * @param quantity {String} Total Quantity as placed by the user
   * @param disclosedQuantity {String} If provided should be minimun of 10% of actual quantity.
   ...
   * @param fillPrice {String} Price at which exchange has filled the order
   ...
   * @param exchangeOrderId {String} Unique Order identifier generated from exchange
   * @param rejectionReason {String} If order is rejected, Cause of order Rejection
   * @param exchangeConfirmationTime {String} Order confirmation time at exchange
   * @param cancelledQuantity {String} cancelled quantity for partial cancelled orders
   * @param referenceLimitPrice {String} Limit Price reference
   * @param coverOrderPercentage {String} Percentage of cover order
   * @param orderRemarks {String} Remarks about order
   * @param exchangeOrderNumber {String} Unique Order identifier generated after placing an order
   * @param symbol {String} symbol about stock
   * @param status {String} Status will display Executed/Pending/Rejected
   * @param exchangeStatus {String} ExchangeStatus will display Executed/Pending/Rejected
   * @param expiry {String} shows ExpiryDate of the stock 
   * @param pendingQuantity {String} PendingQuantity will show pending quantity stock
   * @param instrument {String} Instrument is about the type of stock. FUT/OPT 
   * @param scripName {String} Name of the scrip
   * @param totalQuanity {String} Total Quantity
   * @param optionType {String} Option Type (PE/CE). 
   * @param orderPlaceBy {String} Client code of the user who placed the order
   * @param lotQuantity {String} lotQuantity represents the number of contracts contained in one derivative security.Applicable for F & O 
   * @param parentOrderId {String} order Id of the parent order(it is applicable for only BO/CO orders)
   */
  var exports = function(orderNumber, exchange, tradingSymbol, symbolDescription, transactionType, productCode, orderType, orderPrice, quantity, disclosedQuantity, triggerPrice, marketProtection, orderValidity, orderStatus, orderValue, instrumentName, orderTime, userId, filledQuantity, fillPrice, averagePrice, unfilledQuantity, exchangeOrderId, rejectionReason, exchangeConfirmationTime, cancelledQuantity, referenceLimitPrice, coverOrderPercentage, orderRemarks, exchangeOrderNumber, symbol, status, exchangeStatus, expiry, pendingQuantity, instrument, scripName, totalQuanity, optionType, orderPlaceBy, lotQuantity, parentOrderId) {
   ...
   * @param {module:model/OrderBookEntry} obj Optional instance to populate.
   * @return {module:model/OrderBookEntry} The populated <code>OrderBookEntry</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('fillPrice'))
        obj.fillPrice = ApiClient.convertToType(data['fillPrice'], 'String');
      ...
      if (data.hasOwnProperty('cancelledQuantity'))
        obj.cancelledQuantity = ApiClient.convertToType(data['cancelledQuantity'], 'String');
      if (data.hasOwnProperty('referenceLimitPrice'))
        obj.referenceLimitPrice = ApiClient.convertToType(data['referenceLimitPrice'], 'String');
      ...
      if (data.hasOwnProperty('orderRemarks'))
        obj.orderRemarks = ApiClient.convertToType(data['orderRemarks'], 'String');
      ...
      if (data.hasOwnProperty('displayStrikePrice'))
        obj.displayStrikePrice = ApiClient.convertToType(data['displayStrikePrice'], 'String');
      if (data.hasOwnProperty('displayNetQuantity'))
        obj.displayNetQuantity = ApiClient.convertToType(data['displayNetQuantity'], 'String');
      if (data.hasOwnProperty('status'))
        obj.status = ApiClient.convertToType(data['status'], 'String');
      if (data.hasOwnProperty('exchangeStatus'))
        obj.exchangeStatus = ApiClient.convertToType(data['exchangeStatus'], 'String');
      ...
      if (data.hasOwnProperty('scripName'))
        obj.scripName = ApiClient.convertToType(data['scripName'], 'String');
      if (data.hasOwnProperty('totalQuanity'))
        obj.totalQuanity = ApiClient.convertToType(data['totalQuanity'], 'String');
      if (data.hasOwnProperty('optionType'))
        obj.optionType = ApiClient.convertToType(data['optionType'], 'String');
      if (data.hasOwnProperty('orderPlaceBy'))
        obj.orderPlaceBy = ApiClient.convertToType(data['orderPlaceBy'], 'String');
  ...
  /**
   * Total price of a particular order
   * @member {String} orderPrice
   */
  exports.prototype.orderPrice = undefined;

  /**
   * Total Quantity as placed by the user
   * @member {String} quantity
   */
  exports.prototype.quantity = undefined;

  /**
   * If provided should be minimun of 10% of actual quantity.
   ...
   * @member {String} fillPrice
   */
  exports.prototype.fillPrice = undefined;
   ...
   */
  exports.prototype.exchangeOrderId = undefined;

  /**
   * If order is rejected, Cause of order Rejection
  ...
  /**
   * cancelled quantity for partial cancelled orders
   * @member {String} cancelledQuantity
   */
  exports.prototype.cancelledQuantity = undefined;

  /**
   * Limit Price reference
   * @member {String} referenceLimitPrice
   */
  exports.prototype.referenceLimitPrice = undefined;
  ...
  /**
   * Remarks about order
   * @member {String} orderRemarks
   */
  exports.prototype.orderRemarks = undefined;
  ...
  /**
   *  Shows the strick price  
   * @member {String} displayStrikePrice
   */
  exports.prototype.displayStrikePrice = undefined;

  /**
   *  Display the limit quantity of order
   * @member {String} displayNetQuantity
   */
  exports.prototype.displayNetQuantity = undefined;

  /**
   * Status will display Executed/Pending/Rejected
   * @member {String} status
   */
  exports.prototype.status = undefined;

  /**
   * ExchangeStatus will display Executed/Pending/Rejected
   * @member {String} exchangeStatus
   */
  exports.prototype.exchangeStatus = undefined;

  /**
   * shows ExpiryDate of the stock 
   * @member {String} expiry
   */
  exports.prototype.expiry = undefined;

  /**
   * PendingQuantity will show pending quantity stock
   * @member {String} pendingQuantity
   */
  exports.prototype.pendingQuantity = undefined;

  /**
   * Instrument is about the type of stock. FUT/OPT 
   ...
   */
  exports.prototype.scripName = undefined;

  /**
   * Total Quantity
   * @member {String} totalQuanity
   */
  exports.prototype.totalQuanity = undefined;
   ...
   * @member {String} orderPlaceBy
   */
  exports.prototype.orderPlaceBy = undefined;

  /**
   * lotQuantity represents the number of contracts contained in one derivative security.Applicable for F & O 
   * @member {String} lotQuantity
   */
  exports.prototype.lotQuantity = undefined;

  /**
   * order Id of the parent order(it is applicable for only BO/CO orders)
   * @member {String} parentOrderId
   */
  exports.prototype.parentOrderId = undefined;
