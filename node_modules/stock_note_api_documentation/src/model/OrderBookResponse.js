...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrderBookEntry'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrderBookEntry'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.OrderBookResponse = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.OrderBookEntry);
  }
}(this, function(ApiClient, OrderBookEntry) {
  'use strict';
   ...
   * @param orderBookDetails {Array.<module:model/OrderBookEntry>} List of all orders with details during the day
   */
  var exports = function(serverTime, msgId, status, statusMessage, orderBookDetails) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('orderBookDetails'))
        obj.orderBookDetails = ApiClient.convertToType(data['orderBookDetails'], [OrderBookEntry]);
    }
    return obj;
  }
  ...
  /**
   * List of all orders with details during the day
   * @member {Array.<module:model/OrderBookEntry>} orderBookDetails
   */
  exports.prototype.orderBookDetails = undefined;
