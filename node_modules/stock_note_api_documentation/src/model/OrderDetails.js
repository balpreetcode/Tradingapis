...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.OrderDetails = factory(root.StockNoteApiDocumentation.ApiClient);
  }
   ...
   * @param productType {String} Product Type of order as placed by the user. It can be CNC (Cash and Carry),BO (Bracket Order),CO (Cover Order),NRML (Normal),MIS (Intraday).
