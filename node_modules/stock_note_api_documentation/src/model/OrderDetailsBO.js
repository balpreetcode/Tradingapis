...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.OrderDetailsBO = factory(root.StockNoteApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OrderDetailsBO model module.
   * @module model/OrderDetailsBO
   * @version 1.0
   */

  /**
   * Constructs a new <code>OrderDetailsBO</code>.
   * @alias module:model/OrderDetailsBO
   * @class
   ...
   * @param exchange {String} Name of the exchange.Valid exchanges values (NSE/ NFO/ MCX/ CDS).If the user does not provide an exchange name, by default considered as NSE.For trading with NFO, CDS and MCX, exchange is mandatory. BO orders not applicable for BSE exchange.
   ...
   * @param productType {String} Product Type of order as placed by the user is BO (Bracket Order)
  ...
  /**
   * Constructs a <code>OrderDetailsBO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrderDetailsBO} obj Optional instance to populate.
   * @return {module:model/OrderDetailsBO} The populated <code>OrderDetailsBO</code> instance.
   */
  ...
  /**
   * Name of the exchange.Valid exchanges values (NSE/ NFO/ MCX/ CDS).If the user does not provide an exchange name, by default considered as NSE.For trading with NFO, CDS and MCX, exchange is mandatory. BO orders not applicable for BSE exchange.
  ...
  /**
   * Product Type of order as placed by the user is BO (Bracket Order)
