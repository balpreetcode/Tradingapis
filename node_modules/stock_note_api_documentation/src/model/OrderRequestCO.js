...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.OrderRequestCO = factory(root.StockNoteApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OrderRequestCO model module.
   * @module model/OrderRequestCO
   * @version 1.0
   */

  /**
   * Constructs a new <code>OrderRequestCO</code>.
   * Request object for placing an CO Order.
   * @alias module:model/OrderRequestCO
   * @class
   ...
   * @param productType {String} Product Type of the order. It can be CO (Cover Order))
   */
  var exports = function(symbolName, exchange, transactionType, orderType, quantity, disclosedQuantity, price, orderValidity, productType) {
  ...
  /**
   * Constructs a <code>OrderRequestCO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrderRequestCO} obj Optional instance to populate.
   * @return {module:model/OrderRequestCO} The populated <code>OrderRequestCO</code> instance.
   */
  ...
  /**
   * Product Type of the order. It can be CO (Cover Order))
