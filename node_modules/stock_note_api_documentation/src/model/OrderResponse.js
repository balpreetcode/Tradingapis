...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrderDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrderDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.OrderResponse = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.OrderDetails);
  }
}(this, function(ApiClient, OrderDetails) {
  'use strict';
   ...
   * @param orderDetails {module:model/OrderDetails} Details of the order
   */
  var exports = function(serverTime, msgId, orderNumber, status, statusMessage, exchangeOrderStatus, rejectionReason, orderDetails) {
