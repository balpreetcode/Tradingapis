...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrderDetailsBO'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrderDetailsBO'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.OrderResponseBO = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.OrderDetailsBO);
  }
}(this, function(ApiClient, OrderDetailsBO) {
  'use strict';

  /**
   * The OrderResponseBO model module.
   * @module model/OrderResponseBO
   * @version 1.0
   */

  /**
   * Constructs a new <code>OrderResponseBO</code>.
   * @alias module:model/OrderResponseBO
   * @class
   ...
   * @param orderDetails {module:model/OrderDetailsBO} Details of the order
   */
  ...
  /**
   * Constructs a <code>OrderResponseBO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrderResponseBO} obj Optional instance to populate.
   * @return {module:model/OrderResponseBO} The populated <code>OrderResponseBO</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('orderDetails'))
        obj.orderDetails = OrderDetailsBO.constructFromObject(data['orderDetails']);
    }
    return obj;
  }
   ...
   * @member {module:model/OrderDetailsBO} orderDetails
   */
