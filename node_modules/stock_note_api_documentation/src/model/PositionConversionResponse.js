...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.PositionConversionResponse = factory(root.StockNoteApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PositionConversionResponse model module.
   * @module model/PositionConversionResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>PositionConversionResponse</code>.
   * @alias module:model/PositionConversionResponse
   * @class
   ...
   * @param status {String} Status of the position conversion request.Success / Failure
   * @param statusMsg {String} Status message of position conversion request
   */
  var exports = function(serverTime, msgId, status, statusMsg) {
  ...
  /**
   * Constructs a <code>PositionConversionResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PositionConversionResponse} obj Optional instance to populate.
   * @return {module:model/PositionConversionResponse} The populated <code>PositionConversionResponse</code> instance.
   */
  ...
  /**
   * Status of the position conversion request.Success / Failure
   * @member {String} status
   */
  exports.prototype.status = undefined;

  /**
   * Status message of position conversion request
   * @member {String} statusMsg
   */
  exports.prototype.statusMsg = undefined;
