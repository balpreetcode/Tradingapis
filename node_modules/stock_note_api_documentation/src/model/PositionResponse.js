...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Position', 'model/PositionSummary'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Position'), require('./PositionSummary'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.PositionResponse = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.Position, root.StockNoteApiDocumentation.PositionSummary);
  }
}(this, function(ApiClient, Position, PositionSummary) {
  'use strict';
   ...
   * @param positionSummary {module:model/PositionSummary} Details of user positions
   * @param positionDetails {Array.<module:model/Position>}  Details of Day/Net positions as queried
   */
  var exports = function(serverTime, msgId, status, statusMessage, positionSummary, positionDetails) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('positionSummary'))
        obj.positionSummary = PositionSummary.constructFromObject(data['positionSummary']);
      if (data.hasOwnProperty('positionDetails'))
        obj.positionDetails = ApiClient.convertToType(data['positionDetails'], [Position]);
    }
    return obj;
  }
  ...
  /**
   * Details of user positions
   * @member {module:model/PositionSummary} positionSummary
   */
  exports.prototype.positionSummary = undefined;

  /**
   *  Details of Day/Net positions as queried
   * @member {Array.<module:model/Position>} positionDetails
   */
  exports.prototype.positionDetails = undefined;
