...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SimpleResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SimpleResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.PositionSquareOffListResponse = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.SimpleResponse);
  }
}(this, function(ApiClient, SimpleResponse) {
  'use strict';

  /**
   * The PositionSquareOffListResponse model module.
   * @module model/PositionSquareOffListResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>PositionSquareOffListResponse</code>.
   * @alias module:model/PositionSquareOffListResponse
   * @class
   ...
   * @param positionSquareOffResponseList {Array.<module:model/SimpleResponse>} List of the PositionSquareOff end of the day
   */
  var exports = function(serverTime, msgId, positionSquareOffResponseList) {
    this.serverTime = serverTime;
    this.msgId = msgId;
    this.positionSquareOffResponseList = positionSquareOffResponseList;
  };

  /**
   * Constructs a <code>PositionSquareOffListResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PositionSquareOffListResponse} obj Optional instance to populate.
   * @return {module:model/PositionSquareOffListResponse} The populated <code>PositionSquareOffListResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('positionSquareOffResponseList'))
        obj.positionSquareOffResponseList = ApiClient.convertToType(data['positionSquareOffResponseList'], [SimpleResponse]);
    }
    return obj;
  }
  ...
  /**
   * List of the PositionSquareOff end of the day
   * @member {Array.<module:model/SimpleResponse>} positionSquareOffResponseList
   */
  exports.prototype.positionSquareOffResponseList = undefined;
