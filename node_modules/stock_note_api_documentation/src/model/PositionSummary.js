...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.PositionSummary = factory(root.StockNoteApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PositionSummary model module.
   * @module model/PositionSummary
   * @version 1.0
   */

  /**
   * Constructs a new <code>PositionSummary</code>.
   * @alias module:model/PositionSummary
   * @class
   * @param gainingTodayCount {String} Count of scrips which are gaining in value in a trading day
   * @param losingTodayCount {String} Count of scrips which are losing in value in a trading day
   * @param totalGainAndLossAmount {String} Total amount of Gain / Loss for all existing positions since their creation
   * @param dayGainAndLossAmount {String} Amount of Gain / Loss for all positions on a specific trading day
   */
  var exports = function(gainingTodayCount, losingTodayCount, totalGainAndLossAmount, dayGainAndLossAmount) {
  ...
  /**
   * Constructs a <code>PositionSummary</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PositionSummary} obj Optional instance to populate.
   * @return {module:model/PositionSummary} The populated <code>PositionSummary</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('gainingTodayCount'))
        obj.gainingTodayCount = ApiClient.convertToType(data['gainingTodayCount'], 'String');
      if (data.hasOwnProperty('losingTodayCount'))
        obj.losingTodayCount = ApiClient.convertToType(data['losingTodayCount'], 'String');
      if (data.hasOwnProperty('totalGainAndLossAmount'))
        obj.totalGainAndLossAmount = ApiClient.convertToType(data['totalGainAndLossAmount'], 'String');
      if (data.hasOwnProperty('dayGainAndLossAmount'))
        obj.dayGainAndLossAmount = ApiClient.convertToType(data['dayGainAndLossAmount'], 'String');
    }
    return obj;
  }

  /**
   * Count of scrips which are gaining in value in a trading day
   * @member {String} gainingTodayCount
   */
  exports.prototype.gainingTodayCount = undefined;

  /**
   * Count of scrips which are losing in value in a trading day
   * @member {String} losingTodayCount
   */
  exports.prototype.losingTodayCount = undefined;

  /**
   * Total amount of Gain / Loss for all existing positions since their creation
   * @member {String} totalGainAndLossAmount
   */
  exports.prototype.totalGainAndLossAmount = undefined;

  /**
   * Amount of Gain / Loss for all positions on a specific trading day
   * @member {String} dayGainAndLossAmount
   */
  exports.prototype.dayGainAndLossAmount = undefined;
