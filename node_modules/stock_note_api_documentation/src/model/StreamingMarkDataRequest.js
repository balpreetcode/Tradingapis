...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StockNoteApiDocumentation.StreamingMarkDataRequest = factory(root.StockNoteApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The StreamingMarkDataRequest model module.
   * @module model/StreamingMarkDataRequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>StreamingMarkDataRequest</code>.
   * Request object for Streaming live market data.
   * @alias module:model/StreamingMarkDataRequest
   * @class
   * @param streamingType {String} Streaming type.Added for future use.Pass this value as “marketdata” always
   * @param symbols {Array.<String>} List of symbols contains listing nos used to get marketdata.
   * @param requestType {String} Request type.This can be Subscribe/Unsubscribe. Subscribe - Receive continuous quote data. UnSubscribe - Stop receiving the continuous quote data. *It's important to unsubscribe when the streaming is no longer needed.
   * @param responseFormat {String} Response data format. Currently supports json only
   */
  var exports = function(streamingType, symbols, requestType, responseFormat) {
  ...
  /**
   * Constructs a <code>StreamingMarkDataRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/StreamingMarkDataRequest} obj Optional instance to populate.
   * @return {module:model/StreamingMarkDataRequest} The populated <code>StreamingMarkDataRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('request_type'))
        obj.requestType = ApiClient.convertToType(data['request_type'], 'String');
  ...
  /**
   * Streaming type.Added for future use.Pass this value as “marketdata” always
   * @member {String} streamingType
   */
  exports.prototype.streamingType = undefined;

  /**
   * List of symbols contains listing nos used to get marketdata.
   * @member {Array.<String>} symbols
   */
  exports.prototype.symbols = undefined;

  /**
   * Request type.This can be Subscribe/Unsubscribe. Subscribe - Receive continuous quote data. UnSubscribe - Stop receiving the continuous quote data. *It's important to unsubscribe when the streaming is no longer needed.
   * @member {String} requestType
   */
  exports.prototype.requestType = undefined;

  /**
   * Response data format. Currently supports json only
   * @member {String} responseFormat
   */
  exports.prototype.responseFormat = undefined;
