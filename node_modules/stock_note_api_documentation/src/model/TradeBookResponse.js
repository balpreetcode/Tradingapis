...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TradeBookEntry'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TradeBookEntry'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.TradeBookResponse = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.TradeBookEntry);
  }
}(this, function(ApiClient, TradeBookEntry) {
  'use strict';

  /**
   * The TradeBookResponse model module.
   * @module model/TradeBookResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>TradeBookResponse</code>.
   * @alias module:model/TradeBookResponse
   * @class
   ...
   * @param tradeBookDetails {Array.<module:model/TradeBookEntry>} Get list of TradeBookEntries.
   */
  var exports = function(serverTime, msgId, status, statusMessage, tradeBookDetails) {
  ...
  /**
   * Constructs a <code>TradeBookResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TradeBookResponse} obj Optional instance to populate.
   * @return {module:model/TradeBookResponse} The populated <code>TradeBookResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('tradeBookDetails'))
        obj.tradeBookDetails = ApiClient.convertToType(data['tradeBookDetails'], [TradeBookEntry]);
    }
    return obj;
  }
  ...
  /**
   * Get list of TradeBookEntries.
   * @member {Array.<module:model/TradeBookEntry>} tradeBookDetails
   */
  exports.prototype.tradeBookDetails = undefined;
