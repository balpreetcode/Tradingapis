...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TriggerOrder'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TriggerOrder'));
  } else {
    // Browser globals (root is window)
    if (!root.StockNoteApiDocumentation) {
      root.StockNoteApiDocumentation = {};
    }
    root.StockNoteApiDocumentation.TriggerOrdersResponse = factory(root.StockNoteApiDocumentation.ApiClient, root.StockNoteApiDocumentation.TriggerOrder);
  }
}(this, function(ApiClient, TriggerOrder) {
  'use strict';

  /**
   * The TriggerOrdersResponse model module.
   * @module model/TriggerOrdersResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>TriggerOrdersResponse</code>.
   * @alias module:model/TriggerOrdersResponse
   * @class
   ...
   * @param triggerOrders {Array.<module:model/TriggerOrder>} Trigger order Details available for the provided OrderNumber.
   */
  var exports = function(serverTime, msgId, status, statusMessage, triggerOrders) {
  ...
  /**
   * Constructs a <code>TriggerOrdersResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TriggerOrdersResponse} obj Optional instance to populate.
   * @return {module:model/TriggerOrdersResponse} The populated <code>TriggerOrdersResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('triggerOrders'))
        obj.triggerOrders = ApiClient.convertToType(data['triggerOrders'], [TriggerOrder]);
    }
    return obj;
  }
  ...
  /**
   * Trigger order Details available for the provided OrderNumber.
   * @member {Array.<module:model/TriggerOrder>} triggerOrders
   */
  exports.prototype.triggerOrders = undefined;
