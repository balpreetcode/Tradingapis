...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AskValues', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.AskValues();
      });

      it('should create an instance of AskValues', function() {
        // TODO: update the code to test AskValues
        expect(instance).to.be.a(StockNoteApiDocumentation.AskValues);
      });
