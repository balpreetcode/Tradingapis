...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BidAsk', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.BidAsk();
      });

      it('should create an instance of BidAsk', function() {
        // TODO: update the code to test BidAsk
        expect(instance).to.be.a(StockNoteApiDocumentation.BidAsk);
      });
