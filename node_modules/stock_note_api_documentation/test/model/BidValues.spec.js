...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BidValues', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.BidValues();
      });

      it('should create an instance of BidValues', function() {
        // TODO: update the code to test BidValues
        expect(instance).to.be.a(StockNoteApiDocumentation.BidValues);
      });
