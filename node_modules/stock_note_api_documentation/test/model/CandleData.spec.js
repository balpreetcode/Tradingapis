...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CandleData', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.CandleData();
      });

      it('should create an instance of CandleData', function() {
        // TODO: update the code to test CandleData
        expect(instance).to.be.a(StockNoteApiDocumentation.CandleData);
      });
