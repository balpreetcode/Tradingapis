...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EquitySearchResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.EquitySearchResponse();
      });

      it('should create an instance of EquitySearchResponse', function() {
        // TODO: update the code to test EquitySearchResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.EquitySearchResponse);
      });
