...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoricalCandleResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.HistoricalCandleResponse();
      });

      it('should create an instance of HistoricalCandleResponse', function() {
        // TODO: update the code to test HistoricalCandleResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.HistoricalCandleResponse);
      });
      ...
      it('should have the property historicalCandleData (base name: "historicalCandleData")', function() {
        // TODO: update the code to test the property historicalCandleData
        expect(instance).to.have.property('historicalCandleData');
        // expect(instance.historicalCandleData).to.be(expectedValueLiteral);
      });
