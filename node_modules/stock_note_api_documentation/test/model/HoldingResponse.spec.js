...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HoldingResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.HoldingResponse();
      });

      it('should create an instance of HoldingResponse', function() {
        // TODO: update the code to test HoldingResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.HoldingResponse);
      });
      ...
      it('should have the property holdingDetails (base name: "holdingDetails")', function() {
        // TODO: update the code to test the property holdingDetails
        expect(instance).to.have.property('holdingDetails');
        // expect(instance.holdingDetails).to.be(expectedValueLiteral);
      });
