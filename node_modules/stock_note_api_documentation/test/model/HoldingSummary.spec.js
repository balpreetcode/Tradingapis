...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HoldingSummary', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.HoldingSummary();
      });

      it('should create an instance of HoldingSummary', function() {
        // TODO: update the code to test HoldingSummary
        expect(instance).to.be.a(StockNoteApiDocumentation.HoldingSummary);
      });
