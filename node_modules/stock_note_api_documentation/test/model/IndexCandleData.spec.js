...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IndexCandleData', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.IndexCandleData();
      });

      it('should create an instance of IndexCandleData', function() {
        // TODO: update the code to test IndexCandleData
        expect(instance).to.be.a(StockNoteApiDocumentation.IndexCandleData);
      });
