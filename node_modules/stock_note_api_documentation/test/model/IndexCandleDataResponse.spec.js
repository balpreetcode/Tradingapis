...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IndexCandleDataResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.IndexCandleDataResponse();
      });

      it('should create an instance of IndexCandleDataResponse', function() {
        // TODO: update the code to test IndexCandleDataResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.IndexCandleDataResponse);
      });
      ...
      it('should have the property indexCandleData (base name: "indexCandleData")', function() {
        // TODO: update the code to test the property indexCandleData
        expect(instance).to.have.property('indexCandleData');
        // expect(instance.indexCandleData).to.be(expectedValueLiteral);
      });
