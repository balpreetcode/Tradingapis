...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IndexIntraDayCandleData', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.IndexIntraDayCandleData();
      });

      it('should create an instance of IndexIntraDayCandleData', function() {
        // TODO: update the code to test IndexIntraDayCandleData
        expect(instance).to.be.a(StockNoteApiDocumentation.IndexIntraDayCandleData);
      });
