...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IndexIntraDayCandleDataResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.IndexIntraDayCandleDataResponse();
      });

      it('should create an instance of IndexIntraDayCandleDataResponse', function() {
        // TODO: update the code to test IndexIntraDayCandleDataResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.IndexIntraDayCandleDataResponse);
      });
      ...
      it('should have the property indexIntraDayCandleData (base name: "indexIntraDayCandleData")', function() {
        // TODO: update the code to test the property indexIntraDayCandleData
        expect(instance).to.have.property('indexIntraDayCandleData');
        // expect(instance.indexIntraDayCandleData).to.be(expectedValueLiteral);
      });
