...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IntraDayCandleData', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.IntraDayCandleData();
      });

      it('should create an instance of IntraDayCandleData', function() {
        // TODO: update the code to test IntraDayCandleData
        expect(instance).to.be.a(StockNoteApiDocumentation.IntraDayCandleData);
      });
