...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IntraDayCandleResponses', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.IntraDayCandleResponses();
      });

      it('should create an instance of IntraDayCandleResponses', function() {
        // TODO: update the code to test IntraDayCandleResponses
        expect(instance).to.be.a(StockNoteApiDocumentation.IntraDayCandleResponses);
      });
      ...
      it('should have the property intradayCandleData (base name: "intradayCandleData")', function() {
        // TODO: update the code to test the property intradayCandleData
        expect(instance).to.have.property('intradayCandleData');
        // expect(instance.intradayCandleData).to.be(expectedValueLiteral);
      });
