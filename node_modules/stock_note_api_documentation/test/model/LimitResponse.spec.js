...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LimitResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.LimitResponse();
      });

      it('should create an instance of LimitResponse', function() {
        // TODO: update the code to test LimitResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.LimitResponse);
      });
      ...
      it('should have the property equityLimit (base name: "equityLimit")', function() {
        // TODO: update the code to test the property equityLimit
        expect(instance).to.have.property('equityLimit');
        // expect(instance.equityLimit).to.be(expectedValueLiteral);
      });

      it('should have the property commodityLimit (base name: "commodityLimit")', function() {
        // TODO: update the code to test the property commodityLimit
        expect(instance).to.have.property('commodityLimit');
        // expect(instance.commodityLimit).to.be(expectedValueLiteral);
      });
