...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LoginRequest', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.LoginRequest();
      });

      it('should create an instance of LoginRequest', function() {
        // TODO: update the code to test LoginRequest
        expect(instance).to.be.a(StockNoteApiDocumentation.LoginRequest);
      });
      ...
      it('should have the property yob (base name: "yob")', function() {
        // TODO: update the code to test the property yob
        expect(instance).to.have.property('yob');
        // expect(instance.yob).to.be(expectedValueLiteral);
      });
