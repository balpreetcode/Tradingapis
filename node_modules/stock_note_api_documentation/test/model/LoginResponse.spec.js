...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LoginResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.LoginResponse();
      });

      it('should create an instance of LoginResponse', function() {
        // TODO: update the code to test LoginResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.LoginResponse);
      });
      ...
      it('should have the property exchangeList (base name: "exchangeList")', function() {
        // TODO: update the code to test the property exchangeList
        expect(instance).to.have.property('exchangeList');
        // expect(instance.exchangeList).to.be(expectedValueLiteral);
      });

      it('should have the property orderTypeList (base name: "orderTypeList")', function() {
        // TODO: update the code to test the property orderTypeList
        expect(instance).to.have.property('orderTypeList');
        // expect(instance.orderTypeList).to.be(expectedValueLiteral);
      });

      it('should have the property productList (base name: "productList")', function() {
        // TODO: update the code to test the property productList
        expect(instance).to.have.property('productList');
        // expect(instance.productList).to.be(expectedValueLiteral);
      });
