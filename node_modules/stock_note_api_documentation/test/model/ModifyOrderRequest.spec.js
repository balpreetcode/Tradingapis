...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModifyOrderRequest', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.ModifyOrderRequest();
      });

      it('should create an instance of ModifyOrderRequest', function() {
        // TODO: update the code to test ModifyOrderRequest
        expect(instance).to.be.a(StockNoteApiDocumentation.ModifyOrderRequest);
      });
