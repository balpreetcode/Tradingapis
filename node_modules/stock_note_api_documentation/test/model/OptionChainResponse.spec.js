...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OptionChainResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.OptionChainResponse();
      });

      it('should create an instance of OptionChainResponse', function() {
        // TODO: update the code to test OptionChainResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.OptionChainResponse);
      });
      ...
      it('should have the property optionChainDetails (base name: "optionChainDetails")', function() {
        // TODO: update the code to test the property optionChainDetails
        expect(instance).to.have.property('optionChainDetails');
        // expect(instance.optionChainDetails).to.be(expectedValueLiteral);
      });
