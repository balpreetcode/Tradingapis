...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderBookResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.OrderBookResponse();
      });

      it('should create an instance of OrderBookResponse', function() {
        // TODO: update the code to test OrderBookResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.OrderBookResponse);
      });
      ...
      it('should have the property orderBookDetails (base name: "orderBookDetails")', function() {
        // TODO: update the code to test the property orderBookDetails
        expect(instance).to.have.property('orderBookDetails');
        // expect(instance.orderBookDetails).to.be(expectedValueLiteral);
      });
