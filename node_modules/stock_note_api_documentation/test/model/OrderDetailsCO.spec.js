...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderDetailsCO', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.OrderDetailsCO();
      });

      it('should create an instance of OrderDetailsCO', function() {
        // TODO: update the code to test OrderDetailsCO
        expect(instance).to.be.a(StockNoteApiDocumentation.OrderDetailsCO);
      });
