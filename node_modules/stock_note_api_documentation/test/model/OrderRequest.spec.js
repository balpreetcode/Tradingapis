...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderRequest', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.OrderRequest();
      });

      it('should create an instance of OrderRequest', function() {
        // TODO: update the code to test OrderRequest
        expect(instance).to.be.a(StockNoteApiDocumentation.OrderRequest);
      });
      ...
      it('should have the property afterMarketOrderFlag (base name: "afterMarketOrderFlag")', function() {
        // TODO: update the code to test the property afterMarketOrderFlag
        expect(instance).to.have.property('afterMarketOrderFlag');
        // expect(instance.afterMarketOrderFlag).to.be(expectedValueLiteral);
      });
