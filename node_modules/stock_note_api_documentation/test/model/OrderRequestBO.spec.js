...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderRequestBO', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.OrderRequestBO();
      });

      it('should create an instance of OrderRequestBO', function() {
        // TODO: update the code to test OrderRequestBO
        expect(instance).to.be.a(StockNoteApiDocumentation.OrderRequestBO);
      });
      ...
      it('should have the property squareOffValue (base name: "squareOffValue")', function() {
        // TODO: update the code to test the property squareOffValue
        expect(instance).to.have.property('squareOffValue');
        // expect(instance.squareOffValue).to.be(expectedValueLiteral);
      });

      it('should have the property stopLossValue (base name: "stopLossValue")', function() {
        // TODO: update the code to test the property stopLossValue
        expect(instance).to.have.property('stopLossValue');
        // expect(instance.stopLossValue).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property trailingStopLoss (base name: "trailingStopLoss")', function() {
        // TODO: update the code to test the property trailingStopLoss
        expect(instance).to.have.property('trailingStopLoss');
        // expect(instance.trailingStopLoss).to.be(expectedValueLiteral);
      });
