...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderResponseBO', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.OrderResponseBO();
      });

      it('should create an instance of OrderResponseBO', function() {
        // TODO: update the code to test OrderResponseBO
        expect(instance).to.be.a(StockNoteApiDocumentation.OrderResponseBO);
      });
      ...
      it('should have the property exchangeOrderStatus (base name: "exchangeOrderStatus")', function() {
        // TODO: update the code to test the property exchangeOrderStatus
        expect(instance).to.have.property('exchangeOrderStatus');
        // expect(instance.exchangeOrderStatus).to.be(expectedValueLiteral);
      });
