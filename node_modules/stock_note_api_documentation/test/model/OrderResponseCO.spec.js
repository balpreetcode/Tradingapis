...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderResponseCO', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.OrderResponseCO();
      });

      it('should create an instance of OrderResponseCO', function() {
        // TODO: update the code to test OrderResponseCO
        expect(instance).to.be.a(StockNoteApiDocumentation.OrderResponseCO);
      });
