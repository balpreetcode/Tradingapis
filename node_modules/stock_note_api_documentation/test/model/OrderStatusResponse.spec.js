...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderStatusResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.OrderStatusResponse();
      });

      it('should create an instance of OrderStatusResponse', function() {
        // TODO: update the code to test OrderStatusResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.OrderStatusResponse);
      });
