...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PositionConversionResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.PositionConversionResponse();
      });

      it('should create an instance of PositionConversionResponse', function() {
        // TODO: update the code to test PositionConversionResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.PositionConversionResponse);
      });
      ...
      it('should have the property statusMsg (base name: "statusMsg")', function() {
        // TODO: update the code to test the property statusMsg
        expect(instance).to.have.property('statusMsg');
        // expect(instance.statusMsg).to.be(expectedValueLiteral);
      });
