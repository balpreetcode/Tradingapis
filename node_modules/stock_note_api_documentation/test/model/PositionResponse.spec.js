...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PositionResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.PositionResponse();
      });

      it('should create an instance of PositionResponse', function() {
        // TODO: update the code to test PositionResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.PositionResponse);
      });
      ...
      it('should have the property positionSummary (base name: "positionSummary")', function() {
        // TODO: update the code to test the property positionSummary
        expect(instance).to.have.property('positionSummary');
        // expect(instance.positionSummary).to.be(expectedValueLiteral);
      });

      it('should have the property positionDetails (base name: "positionDetails")', function() {
        // TODO: update the code to test the property positionDetails
        expect(instance).to.have.property('positionDetails');
        // expect(instance.positionDetails).to.be(expectedValueLiteral);
      });
