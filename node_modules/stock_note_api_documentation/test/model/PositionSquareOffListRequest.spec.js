...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PositionSquareOffListRequest', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.PositionSquareOffListRequest();
      });

      it('should create an instance of PositionSquareOffListRequest', function() {
        // TODO: update the code to test PositionSquareOffListRequest
        expect(instance).to.be.a(StockNoteApiDocumentation.PositionSquareOffListRequest);
      });
      ...
      it('should have the property positionSquareOffRequestList (base name: "positionSquareOffRequestList")', function() {
        // TODO: update the code to test the property positionSquareOffRequestList
        expect(instance).to.have.property('positionSquareOffRequestList');
        // expect(instance.positionSquareOffRequestList).to.be(expectedValueLiteral);
      });

      it('should have the property positionSquareOffList (base name: "positionSquareOffList")', function() {
        // TODO: update the code to test the property positionSquareOffList
        expect(instance).to.have.property('positionSquareOffList');
        // expect(instance.positionSquareOffList).to.be(expectedValueLiteral);
      });
