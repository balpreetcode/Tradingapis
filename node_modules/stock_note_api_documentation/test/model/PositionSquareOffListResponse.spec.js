...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PositionSquareOffListResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.PositionSquareOffListResponse();
      });

      it('should create an instance of PositionSquareOffListResponse', function() {
        // TODO: update the code to test PositionSquareOffListResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.PositionSquareOffListResponse);
      });
      ...
      it('should have the property positionSquareOffResponseList (base name: "positionSquareOffResponseList")', function() {
        // TODO: update the code to test the property positionSquareOffResponseList
        expect(instance).to.have.property('positionSquareOffResponseList');
        // expect(instance.positionSquareOffResponseList).to.be(expectedValueLiteral);
      });
