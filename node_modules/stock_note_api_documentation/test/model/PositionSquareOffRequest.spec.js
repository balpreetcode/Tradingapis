...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PositionSquareOffRequest', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.PositionSquareOffRequest();
      });

      it('should create an instance of PositionSquareOffRequest', function() {
        // TODO: update the code to test PositionSquareOffRequest
        expect(instance).to.be.a(StockNoteApiDocumentation.PositionSquareOffRequest);
      });
