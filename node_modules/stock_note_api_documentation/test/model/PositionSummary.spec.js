...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PositionSummary', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.PositionSummary();
      });

      it('should create an instance of PositionSummary', function() {
        // TODO: update the code to test PositionSummary
        expect(instance).to.be.a(StockNoteApiDocumentation.PositionSummary);
      });

      it('should have the property gainingTodayCount (base name: "gainingTodayCount")', function() {
        // TODO: update the code to test the property gainingTodayCount
        expect(instance).to.have.property('gainingTodayCount');
        // expect(instance.gainingTodayCount).to.be(expectedValueLiteral);
      });

      it('should have the property losingTodayCount (base name: "losingTodayCount")', function() {
        // TODO: update the code to test the property losingTodayCount
        expect(instance).to.have.property('losingTodayCount');
        // expect(instance.losingTodayCount).to.be(expectedValueLiteral);
      });

      it('should have the property totalGainAndLossAmount (base name: "totalGainAndLossAmount")', function() {
        // TODO: update the code to test the property totalGainAndLossAmount
        expect(instance).to.have.property('totalGainAndLossAmount');
        // expect(instance.totalGainAndLossAmount).to.be(expectedValueLiteral);
      });

      it('should have the property dayGainAndLossAmount (base name: "dayGainAndLossAmount")', function() {
        // TODO: update the code to test the property dayGainAndLossAmount
        expect(instance).to.have.property('dayGainAndLossAmount');
        // expect(instance.dayGainAndLossAmount).to.be(expectedValueLiteral);
      });
