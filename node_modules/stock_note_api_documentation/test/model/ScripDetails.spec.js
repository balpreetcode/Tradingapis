...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScripDetails', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.ScripDetails();
      });

      it('should create an instance of ScripDetails', function() {
        // TODO: update the code to test ScripDetails
        expect(instance).to.be.a(StockNoteApiDocumentation.ScripDetails);
      });
      ...
      it('should have the property scripDescription (base name: "scripDescription")', function() {
        // TODO: update the code to test the property scripDescription
        expect(instance).to.have.property('scripDescription');
        // expect(instance.scripDescription).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property bodLotQuantity (base name: "bodLotQuantity")', function() {
        // TODO: update the code to test the property bodLotQuantity
        expect(instance).to.have.property('bodLotQuantity');
        // expect(instance.bodLotQuantity).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property quantityInLots (base name: "quantityInLots")', function() {
        // TODO: update the code to test the property quantityInLots
        expect(instance).to.have.property('quantityInLots');
        // expect(instance.quantityInLots).to.be(expectedValueLiteral);
      });
