...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StreamingQuoteDataRequest', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.StreamingQuoteDataRequest();
      });

      it('should create an instance of StreamingQuoteDataRequest', function() {
        // TODO: update the code to test StreamingQuoteDataRequest
        expect(instance).to.be.a(StockNoteApiDocumentation.StreamingQuoteDataRequest);
      });
