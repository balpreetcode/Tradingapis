...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeBookResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.TradeBookResponse();
      });

      it('should create an instance of TradeBookResponse', function() {
        // TODO: update the code to test TradeBookResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.TradeBookResponse);
      });
      ...
      it('should have the property tradeBookDetails (base name: "tradeBookDetails")', function() {
        // TODO: update the code to test the property tradeBookDetails
        expect(instance).to.have.property('tradeBookDetails');
        // expect(instance.tradeBookDetails).to.be(expectedValueLiteral);
      });
