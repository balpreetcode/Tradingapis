...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TriggerOrder', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.TriggerOrder();
      });

      it('should create an instance of TriggerOrder', function() {
        // TODO: update the code to test TriggerOrder
        expect(instance).to.be.a(StockNoteApiDocumentation.TriggerOrder);
      });

      it('should have the property stopLossOrderNo (base name: "stopLossOrderNo")', function() {
        // TODO: update the code to test the property stopLossOrderNo
        expect(instance).to.have.property('stopLossOrderNo');
        // expect(instance.stopLossOrderNo).to.be(expectedValueLiteral);
      });
