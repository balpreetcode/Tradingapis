...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TriggerOrdersResponse', function() {
      beforeEach(function() {
        instance = new StockNoteApiDocumentation.TriggerOrdersResponse();
      });

      it('should create an instance of TriggerOrdersResponse', function() {
        // TODO: update the code to test TriggerOrdersResponse
        expect(instance).to.be.a(StockNoteApiDocumentation.TriggerOrdersResponse);
      });
      ...
      it('should have the property triggerOrders (base name: "triggerOrders")', function() {
        // TODO: update the code to test the property triggerOrders
        expect(instance).to.have.property('triggerOrders');
        // expect(instance.triggerOrders).to.be(expectedValueLiteral);
      });
